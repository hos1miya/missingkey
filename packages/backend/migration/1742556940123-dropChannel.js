export class dropChannel1742556940123 {
		name = 'dropChannel1742556940123'
		...
		async up(queryRunner) {
			...
			await queryRunner.query(`ALTER TABLE "meta" ALTER COLUMN "pinnedPages" SET DEFAULT '{"/featured", "/explore", "/pages", "/about-missingkey"}'::varchar[];`);
			await queryRunner.query(`UPDATE "meta" SET "pinnedPages" = '{"/featured", "/explore", "/pages", "/about-missingkey"}'::varchar[] WHERE "pinnedPages" = '{"/featured", "/channels", "/explore", "/pages", "/about-missingkey"}';`);
			
			// channelUnread1597459042300
			await queryRunner.query(`DROP INDEX "IDX_6a57f051d82c6d4036c141e107"`);

			// channel1596548170836
		...
		async down(queryRunner) {
			...
			// ChannelNoteIdDescIndex1597893996136
			...
			// instancePinnedPages1605585339718
			await queryRunner.query(`ALTER TABLE "meta" ALTER COLUMN "pinnedPages" SET DEFAULT '{"/featured", "/channels", "/explore", "/pages", "/about-missingkey"}'::varchar[];`);
			await queryRunner.query(`UPDATE "meta" SET "pinnedPages" = '{"/featured", "/channels", "/explore", "/pages", "/about-missingkey"}'::varchar[] WHERE "pinnedPages" = '{"/featured", "/explore", "/pages", "/about-missingkey"}';`);

			// fixChannelUserId1629288472000
			await queryRunner.query(`ALTER TABLE "channel" ALTER COLUMN "userId" DROP NOT NULL;`);

			// foreignKeyReports1651224615271
			await queryRunner.query(`DROP INDEX "public"."IDX_note_on_channelId_and_id_desc"`);
			await queryRunner.query(`ALTER TABLE "note" ALTER COLUMN "channelId" DROP DEFAULT`);
			await queryRunner.query(`CREATE INDEX "IDX_f22169eb10657bded6d875ac8f" ON "note" ("channelId")`);
		}
}
