...
import { AdvancedMutingEntityService } from './entities/AdvancedMutingEntityService.js';
...
const $AdvancedMutingEntityService: Provider = { provide: 'AdvancedMutingEntityService', useExisting: AdvancedMutingEntityService };
