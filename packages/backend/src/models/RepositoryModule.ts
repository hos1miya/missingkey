...
const $advancedMutingsRepository: Provider = {
	provide: DI.advancedMutingsRepository,
	useFactory: (db: DataSource) => db.getRepository(AdvancedMuting),
	inject: [DI.db],
};
